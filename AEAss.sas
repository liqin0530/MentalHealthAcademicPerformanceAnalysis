...
LIBNAME ass "/home/u63859271/IST2034_Analytics_Engineering/AEData";

*2.1.2: Read Depression dataset;
DATA ass.oriDepre;
	INFILE "/home/u63859271/IST2034_Analytics_Engineering/AEData/Depression Student Dataset.csv" DSD TRUNCOVER FIRSTOBS = 2;
...
DATA ass.oriPer;
	INFILE "/home/u63859271/IST2034_Analytics_Engineering/AEData/StudentPerformanceFactors.csv" DSD TRUNCOVER FIRSTOBS = 2;
	LENGTH ParentEdu $ 12.;
	INPUT StudyHrsPE
			Attendance
			ParentalInvolvement $
...
/*Data Exploration, Cleaning, Manipulation Contributed by: Ng Li Qin*/
